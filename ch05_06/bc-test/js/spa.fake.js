...
spa.fake = (function () {
  ...
  mockSio = (function () {
    var
      ...
      emit_scorechange, emit_scoreupdate,
      callback_map = {};
    ...
    emit_scorechange = function() {
      setTimeout( function () { 
	$.gevent.publish( 'scorechange', { home_score: 55 } )
	},10000);
	};
		
    emit_scoreupdate = function() {
      setTimeout( function () {
        $.gevent.publish( 'scorechange', { home_score: 60 } )
        },20000);
        };
