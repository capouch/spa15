...
spa.chat = (function () {
  ...
  var
    ...
    onLogin,       onLogout, onScorechange, 
  ...
  onScorechange = function (event, score_map ) {
        jqueryMap.$title.text( 'Score: ' + score_map.home_score ); 
	console.log('Hi scorechange', score_map.home_score);
	};
  ...
  initModule = function ( $append_target ) {
    ...
    $.gevent.subscribe( $list_box, 'scorechange',    onScorechange);
